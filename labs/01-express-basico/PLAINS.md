...
- [x] Verificar se o projeto já possui Node.js e Express configurados.
- [x] Criar ou ajustar o arquivo principal do servidor.
- [x] Criar a rota GET /health.
- [x] Rodar o servidor localmente.
- [x] Testar o endpoint no navegador, Postman ou curl.
- [x] Registrar o resultado final.

## Surprises & Discoveries

- O projeto inicialmente continha apenas o arquivo PLAINS.md, sem package.json e sem src/server.js.
- O comando npm install express criou package.json, package-lock.json e node_modules.
...
Foi criado o arquivo src/server.js com uma API Express escutando na porta 3000 e expondo GET /health.
